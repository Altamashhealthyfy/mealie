...
import RecipeCardImage from "@/components/recipes/RecipeCardImage";
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
          ...
          <TabsContent value="library" className="space-y-6">
            ...
            {isLoading ? (
              ...
              >
                <RecipeCardImage recipe={recipe} isClient={isClient} canEdit={canEditRecipe(recipe)} canDelete={canDeleteRecipe(recipe)} onEdit={handleEditRecipe} onDelete={handleDeleteRecipe} />
