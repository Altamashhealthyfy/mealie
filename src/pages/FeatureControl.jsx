  ...
  const featureGroups = [
    ...
    },
    {
      ...
      features: [
        ...
        { key: 'allow_profile_edit', label: 'Edit Profile Info', type: 'edit', icon: Edit },
        { key: 'can_upload_profile_photo', label: 'Upload Profile Photo', type: 'upload', icon: Camera },
        { key: 'allow_export_data', label: 'Export Data', type: 'edit', icon: Download },
        { key: 'show_my_plans', label: 'Show My Plans Page', type: 'view', icon: Eye },
      ]
    },
    {
      title: 'File Uploads',
      ...
      categories: [
        ...
        },
        {
          ...
          permissions: [
            ...
            { key: 'can_upload_profile_photo', label: 'Upload Profile Photo', type: 'upload' },
