  ...
  return (
    <div className="min-h-screen p-2 sm:p-4 md:p-8">
      <div className="max-w-7xl mx-auto space-y-4 md:space-y-6">
        ...
        <AdvancedFilters searchQuery={searchQuery} setSearchQuery={setSearchQuery} statusFilter={statusFilter} setStatusFilter={setStatusFilter} coachFilter={coachFilter} setCoachFilter={setCoachFilter} addedByCoachFilter={addedByCoachFilter} setAddedByCoachFilter={setAddedByCoachFilter} goalFilter={goalFilter} setGoalFilter={setGoalFilter} sortBy={sortBy} setSortBy={setSortBy} sortOrder={sortOrder} setSortOrder={setSortOrder} lastActiveFilter={lastActiveFilter} setLastActiveFilter={setLastActiveFilter} hasActivePlan={hasActivePlan} setHasActivePlan={setHasActivePlan} healthCoaches={healthCoaches} showCoachFilter={(user?.user_type === 'super_admin' || user?.role === 'admin' || user?.data?.user_type === 'super_admin') && (() => { try { return (localStorage.getItem('admin_view_mode') || 'admin') === 'admin'; } catch { return true; } })()} activeFiltersCount={activeFiltersCount} />
